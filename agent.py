...
from q_network_model import QNetworkCNN

device=torch.device("cuda:0" if torch.cuda.is_available() else "cpu")


class AgentCNN():
    def __init__(self,memory_length,gamma,epsilon_decay,learning_rate,epsilon_min, in_channels,  hidden_size, output_size=3):
